...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_VRReaction p_VRReaction;
        ...
        public static SteamVR_Input_ActionSet_VRReaction VRReaction
        {
            get
            {
                return SteamVR_Actions.p_VRReaction.GetCopy<SteamVR_Input_ActionSet_VRReaction>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_VRReaction = ((SteamVR_Input_ActionSet_VRReaction)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_VRReaction>("/actions/VRReaction")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.VRReaction};
        }
    }
}
